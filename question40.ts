/* 40.	Album: Write a function called make_album() that builds a Object describing
 ...
 to make three dictionaries representing different albums. Print each return value to show 
 that Objects are storing the album information correctly. Add an optional parameter to
  make_album() that allows you to store the number of tracks on an album. If the calling
   line includes a value for the number of tracks, add that value to the album’s Object.
    ...
    const album2: Album = makeAlbum('Artist 2', 'Album 2', 15);
    const album3: Album = makeAlbum('Artist 3', 'Album 3', 10);
